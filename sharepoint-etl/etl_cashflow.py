...
sharepoint_url = f"{sharepoint_base_url}/_api/web/lists/GetByTitle('CashFlow')/items"
...
query = sql.SQL("""
    INSERT INTO cashflow(id,id_account,ingreso,egreso,categoria,descripcion,fecha_hora,tipo_movimiento)
...
for item in items_array:
    try:
        data = (item['ID'],item['CashFlow_x002d_AccountId'],item['Monto'],item['Egreso'],item['Categoria'],item['Descripcion'],item['FechayHora'],item['TipoMovimiento'])
